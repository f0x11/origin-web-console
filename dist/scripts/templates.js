angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/browse/deployment.html',
    ...
    "<div class=\"col-lg-6\">\n" +
    "<h3 translate>Volumes</h3>\n" +
    "<p ng-if=\"!deployment.spec.template.spec.volumes.length && !({ group: 'apps', resource: 'deployments' } | canI : 'update')\" translate>\n" +
    "none\n" +
    "</p>\n" +
    ...
    "{{warning.message}}\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" ng-if=\"warning.reason === 'NoCPURequest' && ({ group: 'apps', resource: 'deployments' } | canI : 'update')\" role=\"button\" translate>Edit Resource <span ng-if=\"!('cpu' | isRequestCalculated : project)\">Requests and</span> Limits</a>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-if=\"!autoscalers.length\">\n" +
    "<a ng-if=\"{resource: 'horizontalpodautoscalers', group: 'autoscaling'} | canI : 'create'\" ng-href=\"project/{{projectName}}/edit/autoscaler?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Add Autoscaler</a>\n" +
  ...
  $templateCache.put('views/directives/deploy-image.html',
    ...
    "</osc-form-section>\n" +
    "<label-editor labels=\"{{'labels'|translate}}\" expand=\"true\" can-toggle=\"false\" help-text=\"{{'Each label is applied to each created resource.'|translate}}\">\n" +
    "</label-editor>\n" +
    "<alerts alerts=\"alerts\"></alerts>\n" +
  ...
  $templateCache.put('views/directives/events-sidebar.html',
    ...
    "<div>\n" +
    "<h2>\n" +
    "<span class=\"events-sidebar-collapse\"><a href=\"\" class=\"fa fa-arrow-circle-o-right\" title=\"{{'Collapse event sidebar'|translate}}\" ng-click=\"collapseSidebar()\"><span class=\"sr-only\">Collapse event sidebar</span></a></span>\n" +
  ...
  $templateCache.put('views/directives/osc-file-input.html',
    ...
    "  </textarea>\n" +
    "<a href=\"\" ng-show=\"(model || fileName) && !disabled && !hideClear\" ng-click=\"cleanInputValues()\" translate>Clear Value</a>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/edit/yaml.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "<translate>{{updated.resource.kind | humanizeKind | upperFirst}} <strong>{{updated.resource.metadata.name}}</strong> has changed since you started editing it. You'll need to copy any changes you've made and edit the {{updated.resource.kind | humanizeKind}} again.</translate>\n" +
    "</div>\n" +
    "<div ng-if=\"resourceDeleted\" class=\"alert alert-warning\">\n" +
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "<translate>{{updated.resource.kind | humanizeKind | upperFirst}} <strong>{{updated.resource.metadata.name}}</strong> has been deleted since you started editing it.</translate>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_service-instance-row.html',
    ...
    "<status-icon status=\"'Pending'\"></status-icon> <translate>Pending</translate>\n" +
    "</span>\n" +
    "<a ng-if=\"(binding | isBindingReady) && ('secrets' | canI : 'get')\" ng-href=\"{{row.getSecretForBinding(binding) | navigateResourceURL}}\" translate>\n" +
    "View Secret\n" +
    "</a>\n" +
    "</div>\n" +
    "</div>\n" +
